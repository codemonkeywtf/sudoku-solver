# Raylib API Reference (Clean Version)

A readable, searchable version of the official Raylib cheatsheet.

Generated for comfortable reading in editors (nvim, VS Code, Obsidian, etc.).
...
- `Vector3 Vector3CubicHermite(Vector3 v1, Vector3 tangent1, Vector3 v2, Vector3 tangent2, float amount) // Calculate cubic hermite interpolation between two vectors and their tangents as described in the GLTF 2.0 specification: https:`
  registry.khronos.org/glTF/specs/2.0/glTF-2.0.html#interpolation-cubic
...
- `Quaternion QuaternionCubicHermiteSpline(Quaternion q1, Quaternion outTangent1, Quaternion q2, Quaternion inTangent2, float t) // Calculate quaternion cubic spline interpolation using Cubic Hermite Spline algorithm as described in the GLTF 2.0 specification: https:`
  registry.khronos.org/glTF/specs/2.0/glTF-2.0.html#interpolation-cubic
